...
| a3h6 | [MSG-A3H6](../src/opt/ai-tools/bin/ai-tools-run.sh) | no enabled agent provides the launcher \"${launcher_name}\" -- refusing to launch | src/opt/ai-tools/bin/ai-tools-run.sh | tests/integration/ai-tools-run.sh | refuse |
...
| x9h7 | [MSG-X9H7](../src/usr/local/bin/ai-tools.sh) | the sandbox is not provisioned for any enabled agent: ${joined%, } -- provision it with: | src/usr/local/bin/ai-tools.sh |  | die |
| k7a6 | [MSG-K7A6](../src/usr/local/bin/ai-tools.sh) | no agent is enabled or resolved, so there is no agent to provision a project for -- ${reason} | src/usr/local/bin/ai-tools.sh |  | die |
...
| z6q6 | [MSG-Z6Q6](../src/usr/local/bin/ai-tools.sh) | a --for run acts on the filesystem AS the target: ${COMMAND} --for ${FOR_OPERATOR} runs ${blocked##*/} as ${FOR_OPERATOR}, and ${INVOKING_USER} holds no sudo grant to do that. | src/usr/local/bin/ai-tools.sh | tests/integration/cli.sh | die |
| u7r7 | [MSG-U7R7](../src/usr/local/bin/ai-tools.sh) | --for is not accepted on ${COMMAND} | src/usr/local/bin/ai-tools.sh | tests/integration/cli.sh | die |
...
| w3q3 | [MSG-W3Q3](../src/usr/local/lib/ai-tools/providers.lib.sh) | refusing every ${conf_key} provider: ${dir} $(ai_tools_conf_untrusted_reason "${dir}") | src/usr/local/lib/ai-tools/providers.lib.sh | tests/unit/providers.sh | _ai_tools_provider_warn |
| n9x8 | [MSG-N9X8](../src/usr/local/lib/ai-tools/providers.lib.sh) | skipping integration $1: $2 $(ai_tools_conf_untrusted_reason "$2") | src/usr/local/lib/ai-tools/providers.lib.sh |  | _ai_tools_provider_warn |
| x8p4 | [MSG-X8P4](../src/usr/local/lib/ai-tools/providers.lib.sh) | enabled with nothing installed: $(printf '%q' "${requested_name}") is enabled in operator.conf (${conf_key}) but no manifest is installed under ${dir} -- install its ai-tools package or remove it; skipping | src/usr/local/lib/ai-tools/providers.lib.sh | tests/unit/providers.sh | _ai_tools_provider_warn |
| m3a5 | [MSG-M3A5](../src/usr/local/lib/ai-tools/providers.lib.sh) | skipping agent ${agent_name}: ${manifest_file} $(ai_tools_conf_untrusted_reason "${manifest_file}") | src/usr/local/lib/ai-tools/providers.lib.sh | tests/unit/providers.sh | _ai_tools_provider_warn |
...
| h6j9 | [MSG-H6J9](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | skipping $(printf '%q' "${fragment}"): a contributed command is named for its provider, in bare lower-case | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | warn |
...
| b5k9 | [MSG-B5K9](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | a malformed interface floor: ${fragment} declares $(printf '%q' "${declared_floor}"), which is not <major>.<minor> | src/usr/local/libexec/ai-tools/ai-tools-admin.sh | tests/unit/admin-commands.sh | coded_refusal |
...
| e3g7 | [MSG-E3G7](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | a verb outside the command charset: ${fragment} declares $(printf '%q' "${verb}") among its verbs, and a verb is a bare lower-case word | src/usr/local/libexec/ai-tools/ai-tools-admin.sh | tests/unit/admin-commands.sh | coded_refusal |
...
| p5c5 | [MSG-P5C5](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | could not seed ${file} | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | warn |
| z6v4 | [MSG-Z6V4](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | not a directory: ${cfg_home} -- ${user}'s ai-tools config cannot be seeded inside it | src/usr/local/libexec/ai-tools/ai-tools-admin.sh | tests/unit/admin-operator-add.sh | warn |
| b6p3 | [MSG-B6P3](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | declined: ${cfg_home} was not created, so ${user}'s ai-tools config cannot be seeded | src/usr/local/libexec/ai-tools/ai-tools-admin.sh | tests/unit/admin-operator-add.sh | warn |
| s9g3 | [MSG-S9G3](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | could not create ${cfg_home} as ${user}:${group} | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | warn |
| u8e9 | [MSG-U8E9](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | could not give ${cfg_home} to ${user}:${group}; removed the directory again | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | warn |
...
| n2j8 | [MSG-N2J8](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | could not create ${cfg} at 700 ${user}:${group} | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | warn |
...
| t4x9 | [MSG-T4X9](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | not enrolled: ${user}'s config in ~/.config/ai-tools could not be seeded, and without allowed-projects it cannot start a session or claim a project -- clear the reason above and re-run | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | die |
...
| p9k2 | [MSG-P9K2](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | config not seeded for ${user}, which stays enrolled -- without allowed-projects in ~/.config/ai-tools it cannot start a session or claim a project | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | warn |
...
| a6d8 | [MSG-A6D8](../src/usr/local/libexec/ai-tools/ai-tools-chown.sh) | NOTICE: secret-named file written by agent considered breached, rotate the secret: ${path} (ai-tools read access revoked; owner ${old_owner} -> ${new_owner}, mode ${old_mode} -> ${new_mode}) | src/usr/local/libexec/ai-tools/ai-tools-chown.sh | packaging/ai-tools.spec, tests/unit/chown.sh | warn |
...
| g4f4 | [MSG-G4F4](../src/usr/local/libexec/ai-tools/ai-tools-launcher-symlink.sh) | no enabled agent provides the launcher \"${LAUNCHER}\" -- refusing to repoint ${LINK} | src/usr/local/libexec/ai-tools/ai-tools-launcher-symlink.sh | tests/integration/symlink-helper.sh | err |
