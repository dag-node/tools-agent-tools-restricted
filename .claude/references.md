...
| h5z4 | [MSG-H5Z4](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | system bootstrap: unknown argument '$1' (--scope minimal|full) | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | reject |
...
| c7s7 | [MSG-C7S7](../src/usr/local/libexec/ai-tools/ai-tools-admin.sh) | system takes a resource or a verb: 'system bootstrap', 'system entrypoints relabel', 'system post-upgrade' | src/usr/local/libexec/ai-tools/ai-tools-admin.sh |  | reject |
