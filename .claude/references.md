...
| g4p4 | [MSG-G4P4](../src/usr/local/libexec/ai-tools/ai-tools-setfacl.sh) | FATAL: owner-only.lib.sh defines no owner-only guard | src/usr/local/libexec/ai-tools/ai-tools-setfacl.sh |  | warn |
