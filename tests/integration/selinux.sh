...
# to un-label a clone is to delete it (`ai-tools --sandbox-remove`).
#
...
# ai_tools_unlabel_project's revert path (the one `--project-unclaim` drives) uncovered: a known gap, recorded rather
# than papered over.
