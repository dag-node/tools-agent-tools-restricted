...
# The consequence of the grammar, seen from the handback's side: a project registered with a comment resolves to its
# operator, and a commented carve-out resolves to no owner.
