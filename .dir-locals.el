...
;; tools/formatters/fill-comments.sh, which fills through it. It mirrors prose-check.py's widths, so the
...
;; is the filler's, through tools/formatters/emacs/ai-tools-fill.el.
