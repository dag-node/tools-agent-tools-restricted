...
| Ending a session that is already running (`--stop`) — the incident ladder's stop rung | `ai-tools-stop.sh` | [cli](.claude/rules/cli.rule.md) + [docs/session-stop.md](docs/session-stop.md) |
