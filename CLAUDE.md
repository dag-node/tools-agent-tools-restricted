...
| Shipped assets: shared skills + per-agent agents, managed-asset seeding | `skills/**`, `.claude/agents/**`, `lib/ai-tools/managed-assets.lib.sh` | [shipped-assets](.claude/rules/shipped-assets.rule.md) |
