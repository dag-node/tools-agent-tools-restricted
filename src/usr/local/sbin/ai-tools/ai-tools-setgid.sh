...
# normalization must not pull a foreign-owned dir into the agent's group. Compared by
# numeric UID for robustness; PROJECTS_UID is -1 (matches nothing) when unenrolled.
